return {
    {
        ...
        config = function()
            ...
            -- Helpers
            local function prompt_binary(default) return vim.fn.input('Binary: ', default or '', 'file') end
            ...
            dap.configurations.rust = {
                {
                    ...
                    type = 'codelldb',
                    request = 'launch',
                    program = function() return cargo_binary() or prompt_binary('target/debug/') end,
                    cwd = '${workspaceFolder}',
                    stopOnEntry = false,
                },
            }
